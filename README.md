...
1. Download the latest release disk image: [**GitStreak-v1.1.7.dmg**](https://github.com/wenujacodes/GitStreak/releases/latest/download/GitStreak-v1.1.7.dmg)
2. Open `GitStreak-v1.1.7.dmg` and **drag `GitStreak.app` into the `Applications` folder shortcut** inside the installer window.
