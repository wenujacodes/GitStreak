...
public final class OAuthService: @unchecked Sendable {
    ...
    /// Step 2: Poll GitHub for Access Token until approved or expired
    ...
    /// Step 3: Fetch the authenticated user's profile info
    ...
    /// Helper: Open GitHub Device login in default browser and copy user code to clipboard
